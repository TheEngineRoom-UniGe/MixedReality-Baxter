...
import cv2
import os
from rospy.core import _TIMEOUT_SHUTDOWN_JOIN
...
class FrameSaver():
    ...
    def handle_command(self, msg):
        if msg.data == True:
            ...
            rospy.signal_shutdown("Stopped recording")
...
def main():
    ...
    frames_folder_path = pkg_path + "/data/frames/" + args.file_name
    if not os.path.exists(frames_folder_path):
        os.makedirs(frames_folder_path)

    frames_log_path = pkg_path + "/data/frames_logs/" + args.file_name + ".txt"
